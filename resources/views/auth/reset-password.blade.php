...
<head>
    ...
    <!-- Page Title  -->
    <title>QuedaLivros-Redifinir senha</title>
    <!-- StyleSheets  -->
                        ...
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Informe a sua senha e conforme a senha.</p>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->
                                ...
                                <form method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="password">Confirmação de senha</label>
                                        <div class="form-control-wrap">
                                            <a tabindex="-1" href="#"
                                                class="form-icon form-icon-right password-switch lg"
                                                data-target="password">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-lg btn-primary btn-block">Modeficar Senha</button>
                                    </div>
                                </form><!-- formulário -->
