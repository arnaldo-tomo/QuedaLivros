...
<head>
    ...
    <title>A ler : {{ $dado->$livroNome }}</title>
    <!-- Favicon -->
                                ...
                                <div class="iq-sub-dropdown iq-user-dropdown">
                                    <div class="iq-card shadow-none m-0">
                                        <div class="iq-card-body p-0 ">
                                            ...
                                            <a href="{{ route('verperfil') }}" class="iq-sub-card iq-bg-primary-hover">
                                            ...
                                            <a href="{{ route('Configurar') }}" class="iq-sub-card iq-bg-primary-hover">
                                                <div class="media align-items-center">
                                                    <div class="rounded iq-card-icon iq-bg-primary">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="iq-card book-detail">
                            <div class="iq-card-body p-0">
                                <iframe src="{{ asset('storage/' . $dado->livroPdf) }}"
                    ...
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        ...
                        <div class="col-md-6">
                            <div class="iq-card-transparent iq-card-block iq-card-stretch iq-card-height">
                                ...
                                <div class="text-primary mb-4">
                                    Publicado em: <span class="text-body">{{ $dado->created_at }}</span>
                                </div>
                    ...
                    <li class="col-md-3">
                        <div class="row align-items-center">
                                ...
                                <div class="position-relative image-overlap-shadow">
                                    <a href="javascript:void();">
                                        <img class="img-fluid rounded w-100"
                                            src="{{ asset('storage/' . $dado->livroImagen) }}" alt=""></a>
                                    <div class="view-book">
                                        <a href="{{ route('lerdetalhes', $dado->id) }}" class="btn btn-sm btn-white">Ler
                                            Livro</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-7 pl-0">
                                ...
                                @endif
                                <div>
                                    <a href="{{ route('lerdetalhes', $dado->id) }}" class="text-dark" tabindex="-1">ler
                ...
                <ul id="favorites-slider" class="list-inline p-0 mb-0 row">
                    <li class="col-md-4">
                        <div class="d-flex align-items-center">
                            <div class="col-5 p-0 position-relative">
                                <a href="javascript:void();">
                                    <img src="{{ asset('images/favorite/01.jpg') }}" class="img-fluid rounded w-100"
                                        alt="">
                                </a>
                            </div>
                            <div class="col-7">
                    ...
                    <li class="col-md-4">
                        <div class="d-flex align-items-center">
                            <div class="col-5 p-0 position-relative">
                                <a href="javascript:void();">
                                    <img src="{{ asset('images/favorite/02.jpg') }}" class="img-fluid rounded w-100"
                                        alt="">
                                </a>
                            </div>
                            <div class="col-7">
                    ...
                    <li class="col-md-4">
                        <div class="d-flex align-items-center">
                            <div class="col-5 p-0 position-relative">
                                <a href="javascript:void();">
                                    <img src="{{ asset('images/favorite/03.jpg') }}" class="img-fluid rounded w-100"
                                        alt="">
                                </a>
                            </div>
                            <div class="col-7">
                    ...
                    <li class="col-md-4">
                        <div class="d-flex align-items-center">
                            <div class="col-5 p-0 position-relative">
                                <a href="javascript:void();">
                                    <img src="{{ asset('images/favorite/04.jpg') }}" class="img-fluid rounded w-100"
                                        alt="">
                                </a>
                            </div>
                            <div class="col-7">
