                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <form action="{{ route('salvarautor') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label>Nome do Autor:</label>
                                    <input type="text" name="autorNome" value="{{ old('autorNome') }}"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" value="{{ old('autorPerfil') }}"
                                            name="autorPerfil" id="autorPerfil" for="customFile">Choose file</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Emial Do Autor:</label>
                                    <input type="email" name="autorEmail" value="{{ old('autorEmail') }}"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Descricao do Autor:</label>
                                    <textarea class="form-control" name="autorDescricao" value="{{ old('autorDescricao') }}" rows="4"></textarea>
                                </div>
